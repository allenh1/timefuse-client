...
const QMetaObject add_group::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_add_group.data,
      qt_meta_data_add_group,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *add_group::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_add_group.stringdata0))
        return static_cast<void*>(const_cast< add_group*>(this));
